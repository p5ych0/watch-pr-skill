...
- **`SKILL.md` is 1,920 characters shorter, and nothing was removed but a repeated
  ...
  above the first fence costs 1,174 back, which is where the net 1,920 comes from.

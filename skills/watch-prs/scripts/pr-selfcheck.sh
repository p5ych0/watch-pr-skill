...
if [ -f "$SKILL" ]; then
    KNOWN='HOME|PATH|PWD|SECONDS|BASH_SOURCE|CLAUDE_PLUGIN_ROOT|REVIEW_BUS_REMOTE|REVIEW_BUS_OWNER|REVIEW_BUS_REPO|REVIEW_ROUND_THRESHOLD|REVIEW_MERGE_STRICT|PR_WATCH_INTERVAL|PR_WATCH_TIMEOUT|PR_CI_INTERVAL|PR_CI_TIMEOUT|PR_CI_GRACE|1|2|3|4|5|6|7|8|9|0|@|\*|\?|#|!|_'

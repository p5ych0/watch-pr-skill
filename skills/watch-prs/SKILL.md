...
# WHY: docs/skill-setup-rationale.md#S01
...
# WHY: docs/skill-setup-rationale.md#S02
...
# WHY: docs/skill-setup-rationale.md#S03
...
# WHY: docs/skill-setup-rationale.md#S04
...
if [[ -z $RB_REMOTE ]]; then
    ...
    if ( RB_TMPPARENT="RbProbe$$$RANDOM$RANDOM"; [[ $RB_TMPPARENT = RbProbe* ]] \
       ...
       && ( RB_ORIGIN_DIR2="RbProbe$$$RANDOM$RANDOM"; [[ $RB_ORIGIN_DIR2 = RbProbe* ]] \
        ...
        # WHY: docs/skill-setup-rationale.md#S08
        RB_TMPPARENT=
        ...
        # WHY: docs/skill-setup-rationale.md#S09
        RB_ORIGIN_DIR=
        ...
        # WHY: docs/skill-setup-rationale.md#S10
        RB_ORIGIN_DIR2=
        [[ -n $RB_TMPPARENT2 ]] \
        ...
        # WHY: docs/skill-setup-rationale.md#S11
        if /usr/bin/env bash -p "$RB_SCRIPTS"/pr-origin.sh read "$RB_ORIGIN_DIR"; then
            ...
            # WHY: docs/skill-setup-rationale.md#S12
            if { [[ -O /dev/fd/9 ]] && [[ -f /dev/fd/9 ]] \
                ...
                # WHY: docs/skill-setup-rationale.md#S13
        ...
        # WHY: docs/skill-setup-rationale.md#S14
            ...
            # WHY: docs/skill-setup-rationale.md#S15
            ...
            # WHY: docs/skill-setup-rationale.md#S16
    ...
    # WHY: docs/skill-setup-rationale.md#S17
    ...
    # WHY: docs/skill-setup-rationale.md#S18
    [[ $RB_REMOTE = *$'\n'* ]] && RB_REMOTE=
    ...
    # WHY: docs/skill-setup-rationale.md#S19
    ...
    # WHY: docs/skill-setup-rationale.md#S20
    ...
    # WHY: docs/skill-setup-rationale.md#S21
    ...
    if ( RB_PIN_DIR="RbProbe$$$RANDOM$RANDOM"; [[ $RB_PIN_DIR = RbProbe* ]] \
       ...
       && ( RB_PIN_SEEN="RbProbe$$$RANDOM$RANDOM"; [[ $RB_PIN_SEEN = RbProbe* ]] \
        ...
        # WHY: docs/skill-setup-rationale.md#S23
        RB_PIN_DIR=
        ...
        # WHY: docs/skill-setup-rationale.md#S24
        ...
        if [[ -n $RB_PIN_SEEN ]] && [[ $RB_PIN_SEEN = "$RB_REMOTE" ]]; then
            ...
            if { ( RB_WORK_DIR="RbProbe$$$RANDOM$RANDOM"; [[ $RB_WORK_DIR = RbProbe* ]] \
               ...
               && {
                    ...
                    # WHY: docs/skill-setup-rationale.md#S27
            ...
            then
                ...
                # WHY: docs/skill-setup-rationale.md#S28
                ...
                then
                    ...
                    # WHY: docs/skill-setup-rationale.md#S29

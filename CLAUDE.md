...
| `skills/watch-prs/scripts/pr-merge-gate.sh` | Every merge gate, evaluated immediately before merging and pinned to the head it checked. 0 merged, 1 blocked, 3 paused for the operator. Was 291 lines in `SKILL.md` — see #26. |

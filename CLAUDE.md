...
- Neither can waive a finding. Both are untrusted context to a reviewer: they
  ...
  **Three are accepted there, one record each.** #160: the transport candidate name
  ...
  real helper and pins with a scan requiring no removal of any kind and no trap. Those cases are what the records

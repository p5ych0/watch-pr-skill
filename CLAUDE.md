...
| `skills/watch-prs/scripts/pr-close-round.sh` | Closes a review round: push, prove the head green, post the summary, request the next pass. Both orderings — the mention as trigger, and the push as trigger — in one place. 0 closed, 1 stopped, 3 paused. Was 247 lines in `SKILL.md` — see #26. |
